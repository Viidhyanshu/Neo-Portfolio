      ...
      {DOODLE_DATA.map((doodle, idx) => (
        <div
          ...
          className={`absolute ${DOODLE_COLORS[doodleColorIndices[idx]]} ${
            doodle.rotate
          } cursor-pointer opacity-70 hover:opacity-100 hover:scale-125 hover:rotate-[15deg] active:scale-95 transition-all duration-100 z-0 select-none pointer-events-auto hidden md:block ${
